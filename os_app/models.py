...
class Professor(models.Model):
    ...
    escola_lotacao = models.ForeignKey(
        Escola,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
    ...
    modalidade = models.CharField('Modalidade', max_length=20, 
                                  choices=MODALIDADE_CHOICES, blank=True)
    turno = models.CharField('Turno', max_length=20, 
                            choices=TURNO_CHOICES, blank=True)
    ...
    # Situação
    em_sala = models.BooleanField('Em Sala', default=True)
    motivo_fora_sala = models.ForeignKey(
        Motivo,
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
    ...
    def escola_atual(self):
        """Retorna a escola de lotação ou núcleo"""
        return self.escola_lotacao or self.escola_nucleo
...
class PerfilUsuario(models.Model):
    """
    Perfil estendido do usuário com permissões e informações adicionais
    """
    ...
    # ====================================================================
    # PERMISSÕES PARA ESCOLAS NÚCLEO
    # ====================================================================
    pode_criar_escola_nucleo = models.BooleanField(
        'Pode Criar Escolas Núcleo',
        default=False,
        help_text='Permissão para cadastrar novas escolas núcleo'
    )
    
    pode_editar_escola_nucleo = models.BooleanField(
        'Pode Editar Escolas Núcleo',
        default=False,
        help_text='Permissão para editar dados de escolas núcleo'
    )
    
    pode_excluir_escola_nucleo = models.BooleanField(
        'Pode Excluir Escolas Núcleo',
        default=False,
        help_text='Permissão para excluir escolas núcleo'
    )
    
    # ====================================================================
    # PERMISSÕES PARA ESCOLAS DEPENDENTES
    # ====================================================================
    pode_criar_escola_dependente = models.BooleanField(
        'Pode Criar Escolas Dependentes',
        default=False,
        help_text='Permissão para cadastrar novas escolas dependentes'
    )
    
    pode_editar_escola_dependente = models.BooleanField(
        'Pode Editar Escolas Dependentes',
        default=False,
        help_text='Permissão para editar dados de escolas dependentes'
    )
    
    pode_excluir_escola_dependente = models.BooleanField(
        'Pode Excluir Escolas Dependentes',
        default=False,
    ...
    def tem_permissao(self, permissao):
        ...
        permissoes_map = {
            ...
            # Escolas Núcleo
            'criar_escola_nucleo': self.pode_criar_escola_nucleo,
            'editar_escola_nucleo': self.pode_editar_escola_nucleo,
            'excluir_escola_nucleo': self.pode_excluir_escola_nucleo,
            
            # Escolas Dependentes
            'criar_escola_dependente': self.pode_criar_escola_dependente,
            'editar_escola_dependente': self.pode_editar_escola_dependente,
            'excluir_escola_dependente': self.pode_excluir_escola_dependente,
